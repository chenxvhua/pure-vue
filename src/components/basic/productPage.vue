        ...
        <el-dialog :title="addAndEdit.formAddAndEditStatus=='add'?addAndEdit.formAddTitle:addAndEdit.formEditTitle" :close-on-click-modal="false" :visible.sync="addAndEdit.showFromAddAndEdit" size="tiny">
            <el-form :model="fromAddAndEditDataParam" ref="fromAddAndEditDataParam" :rules="rules">
                <el-form-item label="产品编码	" :label-width="formLabelWidth" prop="productCode">
                    <el-input :maxlength="maxlength" v-model="fromAddAndEditDataParam.productCode"  auto-complete="off"></el-input>
                </el-form-item>
                <el-form-item label="产品名称" :label-width="formLabelWidth" prop="productName">
                    <el-input :maxlength="maxlength" v-model="fromAddAndEditDataParam.productName"  auto-complete="off"></el-input>
                </el-form-item>
            </el-form>
        ...
        <el-dialog :title="pageCommonkey.pageTitle+'详细'" :visible.sync="showFromDataDetail" size="tiny">
            <el-form :model="fromDataDetail" ref="fromDataDetail"  label-suffix=":">
                <el-form-item label="产品编码" :label-width="formLabelWidth">
                    <span>{{fromDataDetail.productCode}}</span>
                </el-form-item>
                <el-form-item label="产品名称" :label-width="formLabelWidth">
                    <span>{{fromDataDetail.productName}}</span>
                </el-form-item>
            </el-form>
            <div slot="footer" class="dialog-footer">
